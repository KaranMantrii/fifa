...
const mockStadiumData = {
  north: { name: 'North Stand', occupancy: 50, status: 'Normal', color: '#10b981' },
  south: { name: 'South Stand', occupancy: 95, status: 'Critical', color: '#ef4444' },
  east: { name: 'East Stand', occupancy: 40, status: 'Normal', color: '#10b981' },
  west: { name: 'West Stand', occupancy: 60, status: 'Warning', color: '#f59e0b' },
  g1: { name: 'Gate 1', occupancy: 10, status: 'Normal', color: '#10b981' },
  g2: { name: 'Gate 2', occupancy: 20, status: 'Normal', color: '#10b981' },
  g3: { name: 'Gate 3', occupancy: 90, status: 'Critical', color: '#ef4444' },
  g4: { name: 'Gate 4', occupancy: 30, status: 'Normal', color: '#10b981' }
};
...
describe('StadiumMap component', () => {
  ...
  it('reflects selected state with aria-pressed', () => {
    render(<StadiumMap stadiumData={mockStadiumData} handleSectorClick={() => {}} selectedSector={{ id: 'north', ...mockStadiumData.north }} />);
